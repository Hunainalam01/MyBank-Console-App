...
async function bankServices(bank: Bank) {
    ...
    do {
        ...
        // TRANSACTION:
            ...
            let senderAccount = myBank.account.find(
                (acc) => acc.accountNumber == (senderResponse.senderAccNum)
            );
            ...
            let receiverAccount = myBank.account.find(
                (acc) => acc.accountNumber == (receiverResponse.receiverAccNum)
            );
